...
export interface ApiActividadRecreativaActividadRecreativa
  extends Struct.CollectionTypeSchema {
  collectionName: 'actividad_recreativas';
  info: {
    description: '';
    displayName: 'Actividad Recreativa';
    pluralName: 'actividad-recreativas';
    singularName: 'actividad-recreativa';
  };
  options: {
  ...
  attributes: {
    ...
    fechaActividad: Schema.Attribute.Date &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::actividad-recreativa.actividad-recreativa'
    >;
...
export interface ApiTextosGlobalesTextosGlobales
  extends Struct.SingleTypeSchema {
  collectionName: 'textos_globaless';
  info: {
    description: '';
    displayName: 'Textos Globales';
    pluralName: 'textos-globaless';
    singularName: 'textos-globales';
  };
  options: {
    draftAndPublish: true;
  };
